    ...
    render() {
        ...
        return (
            <SharedData.Consumer>{(context) => {
                let { ExamName , ExamQuestion , text} = context;
                    ...
                    <div className="adding_exams">
                        ...
                        <div class="input-group question-input" >
                            ...
                            <fieldset style={{ width: "250px" }} >
                                ...
                                <select onChange={(e) => { ExamName(e) }} className="myList" var1={this.props.MainQ} var2={this.props.Q} var3={this.props.subQ} var4="degree" var5="صحح ما تحته خط" var7="QType" >
                            ...
                            <input style={{ width: "50px;" }} type="text" class="form-control complete-input " onChange={(e) => { ExamName(e) }} var1={this.props.MainQ} var2={this.props.Q} var3={this.props.subQ} var4="Answer" var5="صحح ما تحته خط" var7="QType" placeholder="ادخل الاجابة الصحيح" />
                        </div>
                    </div>
                );
            }}</SharedData.Consumer>
