                    ...
                    <div className="adding_exams">
                        <div class="">
                            <fieldset style={{ width: "450px" }} >
                                ...
                                <input type="text" class="form-control question-input " onChange={(e) => { this.Qname(e) }} var1={this.props.MainQ} var2={this.props.Q} var3={this.props.subQ} var4="Question" var5={this.state.QName} var7="QType" placeholder="ادخل اسم السؤال " />
                            <div class="input-group question-input">
                                
                                <div class="input-group question-input " style={{ marginBottom: "10px" }} ref={(el) => { this.QText = el }}>
                                    <input type="text" class="form-control question-input " onChange={(e) => { ExamName(e) }} var1={this.props.MainQ} var2={this.props.Q} var3={this.props.subQ} var4="Question" var5={this.state.QName} var7="QType" placeholder="ادخل السؤال " />
                                ...
                                <div class="input-group question-input " style={{ marginBottom: "10px", display: "none" }} ref={(el) => { this.Qimage = el }}>
                                    <div style={{ display: "flex" }}>
                                        ...
                                        <div class="box">
                                            <input onChange={(e) => { Examimage(e) }} style={{ display: "none" }} var1={this.props.MainQ} var2={this.props.Q} var3={this.props.subQ} var4="Question" var5={this.state.QName} type="file" var7="QType" id={"Question" + " " + this.props.MainQ + " " + this.props.Q + " " + this.props.subQ} class="inputfile inputfile-4" data-multiple-caption="{count} files selected" multiple />
                                ...
                                <textarea rows="auto" class="form-control question-input " ref={(el) => { this.AText = el }} onChange={(e) => { ExamName(e) }} var1={this.props.MainQ} var2={this.props.Q} var3={this.props.subQ} var4="Answer" var5={this.state.QName} var7="QType" style={{ marginBottom: "10px" }} disabled={this.state.TOrF} cols="50" placeholder="ادخل الاجابة " />
                                <div class="input-group question-input " style={{ marginBottom: "10px", display: "none" }} ref={(el) => { this.Aimage = el }}>
                                    <div style={{ display: "flex" }}>
                                        ...
                                        <div class="box">
                                            <input onChange={(e) => { Examimage(e) }} style={{ display: "none" }} var1={this.props.MainQ} var2={this.props.Q} var3={this.props.subQ} var4="Answer" var5={this.state.QName} type="file" var7="QType" id={"Answer" + " " + this.props.MainQ + " " + this.props.Q + " " + this.props.subQ} class="inputfile inputfile-4" data-multiple-caption="{count} files selected" multiple />
                                ...
                                <fieldset style={{ width: "250px" }} >
                                    ...
                                    <select onChange={(e) => { ExamName(e) }} var1={this.props.MainQ} var2={this.props.Q} var3={this.props.subQ} var4="degree" var5={this.state.QName} var7="QType" className="myList">
